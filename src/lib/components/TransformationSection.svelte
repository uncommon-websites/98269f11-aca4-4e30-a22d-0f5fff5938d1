    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-20">
            <h2 class="text-4xl md:text-5xl font-serif text-gray-900 leading-tight max-w-4xl">
                Real estate acquisitions teams waste 20–30 hours per week on manual deal triage. <span class="font-semibold">Planisphere turns your inbox into an intelligent deal pipeline.</span>
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center p-8">
                        <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <span class="font-medium text-gray-900">Deal pipeline</span>
                            </div>
                            <div class="space-y-2">
            ...
            <div class="space-y-12">
                <h3 class="text-2xl font-serif text-gray-900">
                    One System of Record <br/> For Every Deal, Broker, and Data Point
                </h3>

                <div class="space-y-8">
                    {#each [
                        { id: '01', title: 'Auto-ingest deals from your inbox', icon: Database },
                        { id: '02', title: 'Triage against your buy box criteria', icon: Search },
                        { id: '03', title: 'Manage CAs and data rooms', icon: Settings },
                        { id: '04', title: 'Export to underwriting templates', icon: FileText }
                    ] as feature}
